...
//    primary = Yellow80,
//    onPrimary = Color.Black,  // Ensure proper contrast for text on buttons
//    primaryContainer = YellowGrey80,
...
//    primary = Yellow40,
//    onPrimary = Color.LightGray.copy(alpha = 0.9f),  // Button text color
